...
var MediaObject = /** @class */ (function () {
    function MediaObject(_objectInstance) {
        ...
        this.onInfoUpdate = new rxjs.Observable(function (observer) {
    ...
    MediaObject.prototype.playInBackground = function (iosOptions) { return core.cordovaInstance(this, "playInBackground", { "sync": true }, arguments); };
    ...
    Object.defineProperty(MediaObject.prototype, "infoCallback", {
        get: function () { return core.instancePropertyGet(this, "infoCallback"); },
        set: function (value) { core.instancePropertySet(this, "infoCallback", value); },
        enumerable: false,
        configurable: true
    });
    return MediaObject;
